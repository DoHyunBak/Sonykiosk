...
export function ImageComparisonSlider({
  ...
  return (
    <div className="relative w-full">
      <div
        ref={containerRef}
        className="relative w-full aspect-[21/10] rounded-3xl overflow-hidden cursor-col-resize select-none"
        style={{ backgroundColor: "#f5e6d3" }}
        onMouseDown={handleMouseDown}
        onTouchStart={handleTouchStart}
      >
        {/* Before Image (Smartphone - Slight blur) */}
      ...
      {/* Labels - Outside overflow container so they're always visible */}
